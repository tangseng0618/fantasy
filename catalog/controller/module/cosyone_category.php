...
class ControllerModuleCosyoneCategory extends Controller {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/cosyone_category.tpl')) {
			return $this->load->view($this->config->get('config_template') . '/template/module/cosyone_category.tpl', $data);
		} else {
			return $this->load->view('default/template/module/cosyone_category.tpl', $data);
		}
	}
}