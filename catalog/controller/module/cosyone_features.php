...
class ControllerModuleCosyoneFeatures extends Controller {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/common/cosyone_features.tpl')) {
			return $this->load->view($this->config->get('config_template') . '/template/common/cosyone_features.tpl', $data);
		} else {
			return $this->load->view('default/template/common/cosyone_features.tpl', $data);
		}
	}
