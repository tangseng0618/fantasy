...
class ControllerModuleCosyoneBannerwall extends Controller {
	...
	$this->load->model('tool/image');
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/cosyone_bannerwall.tpl')) {
			return $this->load->view($this->config->get('config_template') . '/template/module/cosyone_bannerwall.tpl', $data);
		} else {
			return $this->load->view('default/template/module/cosyone_bannerwall.tpl', $data);
		}
