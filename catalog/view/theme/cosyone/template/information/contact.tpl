  ...
  <?php } ?>
      ...
      <div class="box-heading"><?php echo $text_location; ?></div>
          <div class="row">
            ...
            <?php if ($geocode) { ?>
  			<a href="https://maps.google.com/maps?q=<?php echo urlencode($geocode); ?>&hl=en&t=m&z=15" target="_blank"><i class="fa fa-map-marker"></i> <?php echo $button_map; ?></a>
  			<?php } ?>
            </div>
            <div class="col-sm-3 margin-b">
            ...
            <div class="panel-body">
              <div class="row">
                ...
                <span class="contrast_font"><?php echo $location['name']; ?></span><br />
                  ...
                  <a href="https://maps.google.com/maps?q=<?php echo urlencode($location['geocode']); ?>&hl=en&t=m&z=15" target="_blank"><i class="fa fa-map-marker"></i> <?php echo $button_map; ?></a>
                  <?php } ?>
                </div>
                <div class="col-sm-3 margin-b">
                <span class="contrast_font"><?php echo $text_telephone; ?></span><br>
