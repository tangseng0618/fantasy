...
class ControllerModuleDSocialLogin extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			if (!isset($this->request->get['module_id'])) {
				$this->model_extension_module->addModule($this->id, $this->request->post[$this->id.'_setting']);
			} else {
				$this->model_extension_module->editModule($module_id, $this->request->post[$this->id.'_setting']);
			}
