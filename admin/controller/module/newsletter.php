...
class ControllerModuleNewsletter extends Controller {
	...
	public function index() {
		...
		if (!isset($this->request->get['module_id'])) {
			$data['action_global'] = $this->url->link('module/newsletter', 'token=' . $this->session->data['token'], 'SSL');
		} else {
			$data['action_global'] = $this->url->link('module/newsletter', 'token=' . $this->session->data['token'] . '&module_id=' . $this->request->get['module_id'], 'SSL');
		}
