...
class ControllerModuleCosyoneTagcloud extends Controller {
	...
	public function index() {
		...
		$data['generate_url'] = $this->url->link('module/cosyone_tagcloud/generate', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('module/cosyone_tagcloud', 'token=' . $this->session->data['token'], 'SSL')
		);

		$data['action'] = $this->url->link('module/cosyone_tagcloud', 'token=' . $this->session->data['token'], 'SSL');
