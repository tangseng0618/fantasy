...
class ControllerCatalogQuestion extends Controller {
	...
	protected function getList() {
		...
		$data['setting'] = $this->url->link('catalog/question/question_setting', 'token=' . $this->session->data['token'], 'SSL');
	...
	public function question_setting() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('catalog/question', 'token=' . $this->session->data['token'], 'SSL'));
		}
		...
		$data['breadcrumbs'][] = array(
			'text' => $this->language->get('heading_title'),
			'href' => $this->url->link('catalog/question', 'token=' . $this->session->data['token'], 'SSL')
		);
		...
		$data['cancel'] = $this->url->link('catalog/question', 'token=' . $this->session->data['token'], 'SSL');
