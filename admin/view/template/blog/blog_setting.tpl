  ...
  <?php if ((!$blogsetting_blogs_per_page) || (!$blogsetting_comment_per_page) || (!$blogsetting_thumbs_w) || (!$blogsetting_thumbs_h) || (!$blogsetting_rel_thumbs_w) || (!$blogsetting_rel_thumbs_h) || (!$blogsetting_rel_characters)) { ?>
    ...
    <div class="panel panel-default">
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" class="form-horizontal">
        ...
        <div class="col-sm-10">
         <input type="text" class="form-control" value="<?php echo $blogsetting_home_title[$language['code']]; ?>" name="blogsetting_home_title[<?php echo $language['code']; ?>]" />
        </div>
        </div>
        ...
        <div class="col-sm-10">
         <input type="text" class="form-control" value="<?php echo $blogsetting_home_page_title[$language['code']]; ?>" name="blogsetting_home_page_title[<?php echo $language['code']; ?>]" />
        </div>
        </div>
        ...
        <div class="col-sm-10">         
         <textarea name="blogsetting_home_description[<?php echo $language['code']; ?>]" id="block<?php echo $language['code']; ?>" class="form-control"><?php echo isset($blogsetting_home_description[$language['code']]) ? $blogsetting_home_description[$language['code']] : ''; ?></textarea>
        </div>
        </div>
        ...
        <div class="col-sm-10">         
         <textarea name="blogsetting_home_meta_description[<?php echo $language['code']; ?>]" id="block<?php echo $language['code']; ?>" class="form-control"><?php echo isset($blogsetting_home_meta_description[$language['code']]) ? $blogsetting_home_meta_description[$language['code']] : ''; ?></textarea>
        </div>
        </div>
        ...
        <div class="col-sm-10">
         <input type="text" class="form-control" value="<?php echo $blogsetting_home_meta_keyword[$language['code']]; ?>" name="blogsetting_home_meta_keyword[<?php echo $language['code']; ?>]" />
        </div>
        </div>
...
<script type="text/javascript"><!--
<?php foreach ($languages as $language) { ?>
$('#block<?php echo $language['code']; ?>').summernote({
	height: 250,
	  toolbar: [
