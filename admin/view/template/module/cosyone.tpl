...
<div id="content">
  ...
  <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-pencil"></i> Cosyone Theme Settings</h3>
      </div>
...
<option value="<?php echo $key;?>" <?php if($cosyone_header_wishlist==$key) { echo " selected"; }?> ><?php echo $cosyone_header_wishlist_list;?></option>
    ...
    <div class="input-group"><span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
   	<input type="text" class="form-control" value="<?php echo isset($cosyone_top_promo_message[$language['code']]) ? $cosyone_top_promo_message[$language['code']] : ''; ?>" name="cosyone_top_promo_message[<?php echo $language['code']; ?>]" />
    </div>
	<?php } ?>
    </div>
    ...
    <?php foreach ($languages as $language) { ?>
    <div class="input-group"><span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
   	<input type="text" class="form-control" value="<?php echo isset($cosyone_custom_menu_title1[$language['code']]) ? $cosyone_custom_menu_title1[$language['code']] : ''; ?>" name="cosyone_custom_menu_title1[<?php echo $language['code']; ?>]" />
    </div>
	<?php } ?>
    ...
    <?php foreach ($languages as $language) { ?>
    <div class="input-group"><span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
    <input type="text" class="form-control" value="<?php echo isset($cosyone_custom_menu_title2[$language['code']]) ? $cosyone_custom_menu_title2[$language['code']] : ''; ?>" name="cosyone_custom_menu_title2[<?php echo $language['code']; ?>]" />
    </div>
	<?php } ?>
    <span class="help-block">* Leave it blank to disable the link</span>
    </div>
    ...
    <?php foreach ($languages as $language) { ?>
    <div class="input-group"><span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
   	<input type="text" class="form-control" value="<?php echo isset($cosyone_custom_menu_block_title[$language['code']]) ? $cosyone_custom_menu_block_title[$language['code']] : ''; ?>" name="cosyone_custom_menu_block_title[<?php echo $language['code']; ?>]" />
    ...
    <?php foreach ($languages as $language) { ?>
    <div class="input-group"><span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
    <textarea name="cosyone_menu_custom_block_content[<?php echo $language['code']; ?>]" id="cosyone_menu_custom_block_content<?php echo $language['code']; ?>" class="form-control"><?php echo isset($cosyone_menu_custom_block_content[$language['code']]) ? $cosyone_menu_custom_block_content[$language['code']] : ''; ?></textarea>
    </div>
	<?php } ?>
    </div>  
    ...
    <?php foreach ($languages as $language) { ?>
    <div class="input-group"><span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
   	<input type="text" class="form-control" value="<?php echo isset($cosyone_text_ql[$language['code']]) ? $cosyone_text_ql[$language['code']] : ''; ?>" name="cosyone_text_ql[<?php echo $language['code']; ?>]" />
    </div>
	<?php } ?>
   ...
   <select name="cosyone_grid_related" class="form-control">
    ...
    <?php foreach ($languages as $language) { ?>
    <div class="input-group"><span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
   	<input type="text" class="form-control" value="<?php echo isset($cosyone_footer_custom_block_title[$language['code']]) ? $cosyone_footer_custom_block_title[$language['code']] : ''; ?>" name="cosyone_footer_custom_block_title[<?php echo $language['code']; ?>]" />
    </div>
	<?php } ?>
    </div>
    ...
    <?php foreach ($languages as $language) { ?>
    <div class="input-group"><span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
    <textarea name="cosyone_footer_custom_block[<?php echo $language['code']; ?>]" id="cosyone_footer_custom_block<?php echo $language['code']; ?>" class="form-control"><?php echo isset($cosyone_footer_custom_block[$language['code']]) ? $cosyone_footer_custom_block[$language['code']] : ''; ?></textarea>
    </div>
	<?php } ?>
    </div>
    ...
    <?php foreach ($languages as $language) { ?>
    <div class="input-group"><span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
   	<input type="text" class="form-control" value="<?php echo isset($cosyone_cookie_text[$language['code']]) ? $cosyone_cookie_text[$language['code']] : ''; ?>" name="cosyone_cookie_text[<?php echo $language['code']; ?>]" />
    </div>
	<?php } ?>
    </div>
    ...
    <?php foreach ($languages as $language) { ?>
    <div class="input-group"><span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
   	<input type="text" class="form-control" value="<?php echo isset($cosyone_cookie_button_readmore[$language['code']]) ? $cosyone_cookie_button_readmore[$language['code']] : ''; ?>" name="cosyone_cookie_button_readmore[<?php echo $language['code']; ?>]" />
    </div>
	<?php } ?>
    </div>
    ...
    <?php foreach ($languages as $language) { ?>
    <div class="input-group"><span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
   	<input type="text" class="form-control" value="<?php echo isset($cosyone_cookie_button_accept[$language['code']]) ? $cosyone_cookie_button_accept[$language['code']] : ''; ?>" name="cosyone_cookie_button_accept[<?php echo $language['code']; ?>]" />
    </div>
	<?php } ?>
    </div>
    ...
    <?php foreach ($languages as $language) { ?>
    <div class="input-group"><span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
   	<input type="text" class="form-control" value="<?php echo isset($cosyone_ie_text[$language['code']]) ? $cosyone_ie_text[$language['code']] : ''; ?>" name="cosyone_ie_text[<?php echo $language['code']; ?>]" />
    </div>
	<?php } ?>
    </div>
    ...
    <?php foreach ($languages as $language) { ?>
    <div class="input-group"><span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
   	<input type="text" class="form-control" value="<?php echo isset($cosyone_ie_update_text[$language['code']]) ? $cosyone_ie_update_text[$language['code']] : ''; ?>" name="cosyone_ie_update_text[<?php echo $language['code']; ?>]" />
    </div>
	<?php } ?>
    </div>    
...
<?php foreach ($languages as $language) { ?>
$('#cosyone_menu_custom_block_content<?php echo $language['code']; ?>').summernote({height: 200});
<?php } ?>

<?php foreach ($languages as $language) { ?>
$('#cosyone_footer_custom_block<?php echo $language['code']; ?>').summernote({height: 200});
<?php } ?>
