        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-cosyone_tagcloud" class="form-horizontal">
          ...
          <?php foreach ($languages as $language) { ?>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                 <input type="text" name="cosyone_tagcloud_title[<?php echo $language['code']; ?>]" value="<?php echo isset($cosyone_tagcloud_title[$language['code']]) ? $cosyone_tagcloud_title[$language['code']] : ''; ?>" name="cosyone_ie_update_text[<?php echo $language['code']; ?>]
                 " class="form-control"/>
                </div>
            </div>
            <?php } ?>
