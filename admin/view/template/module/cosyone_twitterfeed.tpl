        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-cosyone_twitterfeed" class="form-horizontal">
          ...
          <?php foreach ($languages as $language) { ?>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                 <input type="text" name="cosyone_twitterfeed_title[<?php echo $language['code']; ?>]" value="<?php echo isset($cosyone_twitterfeed_title[$language['code']]) ? $cosyone_twitterfeed_title[$language['code']] : ''; ?>" class="form-control"/>
                </div>
            </div>
            <?php } ?>
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="entry-client_id">Widget ID</label>
            <div class="col-sm-10">
