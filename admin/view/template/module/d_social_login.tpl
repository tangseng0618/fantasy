              ...
              <div class="tab-content">
                <div id="setting_basic" class="tab-pane active">
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" name="<?php echo $id;?>_setting[name]" id="input_name" class="form-control" value="<?php echo  $setting['name']; ?>"/>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <select name="<?php echo $id;?>_setting[status]" id="input_status" class="form-control">
                 ...
                 <!--  <div class="form-group">
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="hidden" name="<?php echo $id;?>_setting[base_url_index]" value="0" />
                      <input type="checkbox" name="<?php echo $id;?>_setting[base_url_index]" <?php echo ($setting['base_url_index'])? 'checked="checked"':'';?> value="1" id="input_base_url_index"/>
                      </div>
                  </div>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <select name="<?php echo $id;?>_setting[return_page]" id="select_return_page" class="form-control">
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        ...
                        <div class="well well-sm clearfix sort-item">
                            <div class="row">
                              <div class="col-sm-3">
                              <span for="d_social_login_settings_providers_<?php echo $key; ?>_enabled">
